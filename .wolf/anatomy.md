...
> Auto-maintained by OpenWolf. Last scanned: 2026-06-10T23:24:54.183Z
...
- `integration.rs` — `directories` resolves the base dir from $HOME on unix, so overriding HOME (~5472 tok)
- `privacy.rs` — Spec §7: after a full ephemeral session, zero bytes of transcript touch the (~3908 tok)
